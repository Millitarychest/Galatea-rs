...
pub trait GalateaHookEvents {
    fn etw_process_handle_opened(actor_pid: u32, target_pid: u32);
    fn etw_virtual_mem_allocated(actor_pid: u32, target_pid: u32, base_address: usize, size: usize, flags: u32, protection: u32);
